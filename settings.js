...
SESSION_ID: process.env.SESSION_ID || "LAKA-MD=IkR1xYgC#i6NmbV_K-V2K0hFlisQuJg47VhRgL94H96Dt9MW4-Ro",
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === undefined ? '' : process.env.DELEMSGSENDTO
};
